...
/** fixed bug Android 10+ tanks for blankj code by ninja coder and blankj */
public final class ThreadCompat {
  ...
  public static <T> void runInBackground(
      ...
      final OnProgressUpdateListener<T> onProgressUpdateListener,
  ...
  /**
   * Return a thread pool that creates new threads as needed, but will reuse previously constructed
  ...
  /**
   * Return a thread pool that creates (2 * CPU_COUNT + 1) threads operating off a queue which size
   * is 128.
   *
